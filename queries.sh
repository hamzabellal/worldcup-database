...
echo "$($PSQL "SELECT name FROM teams RIGHT JOIN games ON teams.team_id=games.winner_id OR teams.team_id=opponent_id WHERE year=2014 AND round='Eighth-Final' ORDER BY name")"
